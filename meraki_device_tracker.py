...
# Dynamic scheduling based on variables
if SCHEDULE_UNIT == 'minutes':
    schedule.every(SCHEDULE_INTERVAL).minutes.do(fetch_and_save_device_data)
elif SCHEDULE_UNIT == 'hours':
    schedule.every(SCHEDULE_INTERVAL).hours.do(fetch_and_save_device_data)
elif SCHEDULE_UNIT == 'days':
    schedule.every(SCHEDULE_INTERVAL).days.do(fetch_and_save_device_data)
# Add more conditions here if needed for weeks, months, etc.

if __name__ == '__main__':
    # Run the function once before starting the schedule
